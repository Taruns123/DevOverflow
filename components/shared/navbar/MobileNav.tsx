    ...
    return (
        <Sheet>
            ...
            <SheetContent side="left" className="
                background-light900_dark200 border-none
            ">
                <Link href='/' className="flex items-center gap-1">
                    <Image
                        ...
                        alt='DevFlow'
                    />
                    <p className='h2-bold  text-dark-100_light900 font-spaceGrotesk '>Dev <span className='text-primary-500'>
                        Overflow   </span></p>
                </Link>
                <div>
                    <SheetClose asChild>
                    ...
                    {/* Todo: Only show when signed out */}
